...
- **Location Tracking**: Real-time GPS location sharing to emergency contacts
- **Multi-Channel Alerts**: SMS, audio alarm, flashlight, and vibration notifications
- **Emergency Contacts**: Easy management and configuration of emergency contacts
- **Live Map Display**: View current location on interactive map
- **Volume Button Trigger**: Activate emergency via physical volume buttons (optional)
- **Compass Navigation**: Built-in compass for orientation
- **Offline Functionality**: App works without internet for core features
- **Cross-Platform**: Available on Android, iOS, Web, Windows, and Linux
