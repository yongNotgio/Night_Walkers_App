        ...
        children: [
            ...
            _buildSection('Emergency Features', [
              ...
              ListTile(
                ...
                subtitle: Text(_ringtoneOptions.entries.firstWhere((e) => e.value == _selectedRingtone, orElse: () => const MapEntry('Default Alarm', 'alarm.wav')).key),
                    ...
                    builder:
                        (context) => AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: _ringtoneOptions.entries.map((entry) => RadioListTile<String>(
                              title: Text(entry.key),
                              value: entry.value,
                              groupValue: _selectedRingtone,
                              onChanged: (value) {
                                setState(() => _selectedRingtone = value!);
                                _saveSetting('selected_ringtone', value!);
                                Navigator.pop(context);
                              },
                            )).toList(),
                          ),
